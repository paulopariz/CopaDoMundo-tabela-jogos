...
function linkGrupos(){
  ...
  document.getElementById("dia03").textContent = "Oitavas de final - Sab, 03/12" ;
  document.getElementById("dia04").textContent = "Oitavas de final - Dom, 04/12" ;
  document.getElementById("dia05").textContent = "Oitavas de final - Seg, 05/12" ;
  document.getElementById("dia06").textContent = "Oitavas de final - Ter, 06/12" ;
  document.getElementById("dia09").textContent = "Quartas de final - Sex, 09/12" ;
  document.getElementById("dia10").textContent = "Quartas de final - Sab, 10/12" ;
  document.getElementById("dia13").textContent = "Semifinais - Ter, 13/12" ;
  document.getElementById("dia14").textContent = "Semifinais - Qua, 14/12" ;
  document.getElementById("dia17").textContent = "Disputa pelo terceiro lugar - Sab, 17/12" ;
  document.getElementById("dia18").textContent = "Final - Dom, 18/12" ;
